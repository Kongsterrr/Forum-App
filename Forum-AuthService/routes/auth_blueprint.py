...
from controllers.auth_controller import CodeVerifyView, SendEmailView, UserRegisterView
...
auth_blueprint.add_url_rule('/auth/token/verify', view_func=CodeVerifyView.as_view('auth-token'), methods=['POST'])
